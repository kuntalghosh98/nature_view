...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Page Header */}
      <section className="relative overflow-hidden bg-gradient-to-br from-forest-900 via-forest-800 to-forest-950 py-20 lg:py-28">
        {/* Decorative blurs */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <h1
            className="mt-6 text-4xl font-bold tracking-tight text-white lg:text-5xl font-display"
          >
            ...
            <div className="sticky top-8 space-y-6">
              ...
              >
                {contactInfo.map((info, idx) => (
                  <div
                    key={idx}
                    className="group flex items-start gap-4 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-md hover:border-forest-200/60 hover:-translate-y-0.5"
                  >
                    <div className="flex shrink-0 items-center justify-center w-12 h-12 rounded-xl bg-forest-50 text-forest-600 transition-all duration-300 group-hover:bg-forest-100 group-hover:text-forest-700">
                      {info.icon}
                    </div>
