  ...
  return (
    <form onSubmit={handleSubmit} className="relative max-w-2xl">
      ...
      <button
        ...
        className="absolute right-1.5 top-1/2 -translate-y-1/2 inline-flex h-10 items-center rounded-full bg-forest-700 px-5 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:bg-forest-300 disabled:text-forest-500 disabled:hover:bg-forest-300"
      >
        {t('searchBar.button')}
