...
export default function AdminLoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-[#f7f4ed] lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden bg-forest-900 text-white lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-base leading-7 text-white/74">
              Sprint 1 starts with a focused admin foundation: authentication, roles, and audit visibility.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center justify-center px-4 py-10 sm:px-6">
        <form onSubmit={handleSubmit} className="w-full max-w-md rounded-lg border border-forest-900/10 bg-white p-6 shadow-panel sm:p-8">
          <div className="mb-8">
            <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-forest-700 text-white lg:hidden">
              <Leaf size={22} />
            </div>
          ...
          <input
            ...
            className="mt-2 w-full rounded-lg border border-forest-900/15 px-3 py-3 outline-none transition focus:border-forest-700 focus:ring-4 focus:ring-forest-100"
            required
          />
          ...
          <button
            type="submit"
            disabled={submitting}
            className="mt-6 w-full rounded-lg bg-forest-700 px-4 py-3 text-sm font-semibold text-white transition hover:bg-forest-900 disabled:cursor-not-allowed disabled:opacity-65"
          >
