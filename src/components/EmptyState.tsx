  ...
  return (
    ...
    >
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-forest-600 text-white text-sm font-medium hover:bg-forest-700 transition-all duration-300 hover:shadow-lg hover:shadow-forest-200"
        >
          <X className="w-4 h-4" />
          {actionLabel}
        </button>
